...
import com.manar.microservices.ProductsLine.ProductLine;
...
public class Products {
	 ...
	 @Column(name = "MSRP")
	  ...
	  @Autowired
	public Products(String productCode, String productName, ProductLine productLine, String productScale,
